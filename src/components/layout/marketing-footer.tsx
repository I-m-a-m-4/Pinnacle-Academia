          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 pt-12">
            ...
            <div className="">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <a href="https://wa.me/2349064233805?text=Hello%2C%20I'm%20interested%20in%20Pinnacle%20Academia.%20I'd%20like%20to%20learn%20more%20about%20your%20tutorial%20services." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="inline-flex h-9 w-9 items-center justify-center rounded-full ring-1 transition bg-white/5 ring-white/10 text-white/80 hover:text-white hover:bg-white/10">
