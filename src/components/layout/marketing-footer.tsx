        ...
        <div className="z-10 sm:p-12 md:p-16 pt-12 pr-8 pb-8 pl-8 relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 pt-12">
            ...
            <div className="">
              ...
              <div className="mt-8">
                <a href="https://www.producthunt.com/products/zeneva-2?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-zeneva-2" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                  <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1131056&theme=dark&t=1776987085952" alt="Zeneva - One OS for Retail: POS, Inventory, and AI Business Insights | Product Hunt" width="250" height="54" className="w-52 h-auto" />
                </a>
              </div>
            </div>
          </div>
