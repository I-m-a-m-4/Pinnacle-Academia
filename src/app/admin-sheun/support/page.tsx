...
function ChatDetail({ thread, adminUser }: { thread: SupportThread, adminUser: StudentProfile }) {
...
export default function AdminSupportPage() {
    ...
    const adminUser = { id: 'admin', name: 'Zeneva Support', email: 'support@zeneva.com' } as StudentProfile;
