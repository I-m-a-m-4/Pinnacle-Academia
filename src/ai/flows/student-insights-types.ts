...
export const StudentInsightsInputSchema = z.object({
  customerName: z.string().describe('The name of the customer.'),
  purchaseHistory: z.array(PurchaseHistoryItemSchema).describe('A list of subjects the customer has purchased.'),
...
export const StudentInsightsOutputSchema = z.object({
